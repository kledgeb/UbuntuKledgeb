(function(a) {
  a.fn.lightBox = function(p) {
    p = jQuery.extend({
      ...
      imageLoading: "//kledgeb.github.io/UbuntuKledgeb/Image/lb-loading.gif",
      imageBtnPrev: "//kledgeb.github.io/UbuntuKledgeb/Image/lb-prev.gif",
      imageBtnNext: "//kledgeb.github.io/UbuntuKledgeb/Image/lb-next.gif",
      imageBtnClose: "//kledgeb.github.io/UbuntuKledgeb/Image/lb-close.gif",
      imageBlank: "//kledgeb.github.io/UbuntuKledgeb/Image/lb-blank.gif",
...
$(document).ready(function() {
  $('#id_divPostBody a[href$=jpg]:has(img)').lightBox();
  $('#id_divPostBody a[href$=png]:has(img)').lightBox();
