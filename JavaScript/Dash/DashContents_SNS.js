...
function setupSNSLens_SharePost(){
  ...
  var sharePost = [
    ...
    
    {
      ...
      link:"//b.hatena.ne.jp/add?mode=confirm&url=" + gPostInfo.canonicalUrl + "&title=" + postTitle,
      iconURL:'//lh3.googleusercontent.com/-7M3z08cysmU/VRolAQl79OI/AAAAAAABAQU/AwmWm4pcecY/s800/HatenaButton_48.jpg',
    },
    
    {
      title:'記事をツイッターで共有',
      link:"//twitter.com/share?url=" + gPostInfo.canonicalUrl + "&text="  + postTitle + "&hashtags=kledgeb",
...

    {
      ...
      link:"//www.linkedin.com/shareArticle?mini=true&url=" + gPostInfo.canonicalUrl + "&title="  + postTitle,
      iconURL:'//lh4.googleusercontent.com/-4W5qWmMr9Pg/VRolAne3NxI/AAAAAAABAQE/rMOr8CJ4f9E/s800/LinkedinButton_48.jpg',
    },
    
    {
      title:'Feedlyで購読',
      link:'//cloud.feedly.com/#subscription%2Ffeed%2Fhttp%3A%2F%2Ffeeds.feedburner.com%2FKledgeb',
